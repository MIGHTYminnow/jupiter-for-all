<?php
/**
 * Replace <div id="theme-page"> with <main id="theme-page">.
 *
 * Original location: /framework/helpers/global.php
 */
...
?>
		...
		<main id="theme-page" class="master-holder <?php echo esc_attr( $master_holder_class ); ?> clearfix" <?php echo esc_attr( $schema_markup ); ?>>
