...
if ($view_params['i'] == 1) {
    ...
    $featured_image_src = Mk_Image_Resize::resize_by_id_adaptive( get_post_thumbnail_id(), $view_params['image_size_magazine'], $image_width, $image_height, $crop = true, $dummy = true);
...
if ($view_params['disable_meta'] == 'true') {
    ...
    $output.= '</time>';
    $output.= '<span class="mk-categories">&nbsp;' . __('', 'jupiter-donut') . ' ' . get_the_category_list(', ') . '</span>';
