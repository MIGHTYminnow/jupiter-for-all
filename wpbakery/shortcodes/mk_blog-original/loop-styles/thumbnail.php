<?php
    ...
    $output .= '<div class="item-wrapper">';
        ...
        $mk_teader_button_text = __('READ MORE', 'jupiter-donut');
        $output .= do_shortcode( '[mk_button dimension="outline" corner_style="pointed" outline_skin="dark" margin_bottom="0" size="medium" align="left" url="' . esc_url( get_permalink() ) . '"]'.$mk_teader_button_text.'[/mk_button]' );
        $output .= '</div>';
