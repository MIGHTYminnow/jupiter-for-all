...
//if (!empty($attachment_id)) {
    ...
    $output.= '<div class="item-wrapper">';
        ...
        $output.= do_shortcode('[mk_button dimension="outline" corner_style="pointed" outline_skin="light" size="medium" align="center" url="' . esc_url( get_permalink() ) . '"]' . __('READ MORE', 'jupiter-donut') . '[/mk_button]');
        $output.= '</div>';
        // end:[mk-blog-meta]
