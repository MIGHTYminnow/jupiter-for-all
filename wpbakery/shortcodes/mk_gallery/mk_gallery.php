...
<section id="gallery-loop-<?php echo $id; ?>" <?php echo implode(' ', $data_config); ?> class="mk-gallery <?php echo $mansory_style. $el_class . ' jupiter-donut-' . $visibility; ?> js-loop js-el jupiter-donut-clearfix <?php echo $lazylaod_class; ?>">
