...
<div class="main-nav-side-search">
	...
	<a class="mk-search-trigger <?php echo $icon_height; ?> mk-toggle-trigger" href="#"><span class="mk-svg-icon-wrapper"><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true, 'mk-icon-search', 16); ?></span> <?php echo $screen_reader_text; ?></a>
	...
	<div id="mk-nav-search-wrapper" class="mk-box-to-trigger">
		<form method="get" id="mk-header-navside-searchform" action="<?php echo home_url('/'); ?>">
			...
			<span class="nav-side-search-icon">
				<button type="submit">
...
<?php } elseif ($mk_options['header_search_location'] == 'fullscreen_search') { ?>
	...
	<div class="main-nav-side-search">
		<a class="mk-search-trigger <?php echo $icon_height; ?> mk-fullscreen-trigger" href="#">
			<span class="mk-svg-icon-wrapper"><?php Mk_SVG_Icons::get_svg_icon_by_class_name(true, 'mk-icon-search', 16); ?></span>
