		...
		<div id="mk-quick-contact">
			...
			<form class="mk-contact-form" method="post" novalidate="novalidate">
				...
				<span class="captcha-image-holder">
					<?php
						ob_start();
						Mk_Theme_Captcha::create_captcha_image();
						$create_captcha_image = ob_get_clean();
					?>
					<img src="<?php echo esc_url( $create_captcha_image ); ?>" class="captcha-image" alt="captcha txt"/>
				</span>
				<br/>
				<?php endif; ?>
